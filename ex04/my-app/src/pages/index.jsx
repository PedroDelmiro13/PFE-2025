...
<p className="text-xl text-black mb-4 text-center">Esse site tem fins acadêmicos e foi criado para praticar com o NextJS.</p>

<ol className="text-left text-black mt-10 space-y-2 mx-auto w-fit">
